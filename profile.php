			...
			<!-- Page header -->
				...
				<div class="page-content-wrapper">	
					<ul class="nav nav-tabs" >
						<li class="active"><a href="#data" data-toggle="tab"> Data Diri </a></li>
						<li><a href="#pass" data-toggle="tab">Ganti Password </a></li>
					</ul>	
	
					<div class="tab-content">
						<div class="tab-pane active" id="data">
						<form role="form" method="post" action="config/update_profil.php">
						  <div class="col-lg-6">
							<div class="form-group">
								<input name="id" type="hidden" id="id" class="form-control" required  value="<?php echo $_SESSION['id']; ?>" />  
							</div> 
							
							<div class="form-group">
								<label> Nama Lengkap </label>
								<input name="nama" type="text" id="nama" class="form-control" required  value="<?php echo $_SESSION['nama']; ?>" />  
							</div>  
		  
							<div class="form-group">
								<label>Alamat Email </label>
								<input name="email" type="text" id="email"  class="form-control" required value="<?php echo $_SESSION['email']; ?>" /> 
							</div> 	  
	  
							<div class="form-group">
								<label>Alamat Domisili </label>
								<input name="alamat" type="text" id="alamat" class="form-control" required value="<?php echo $_SESSION['alamat']; ?>" /> 
							</div>  
		  
							<div class="form-group">
								<label>No Telp / HP </label>
								<input name="hp" type="text" id="hp" class="form-control" required value="<?php echo $_SESSION['hp']; ?>" />  
							</div>    
