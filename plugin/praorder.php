...
$pdf->Cell(6,1,'Harga Pesanan',0,0,'L');
$pdf->Cell(6,1,': Rp '.$dataku['harga_paket'],0,0, 'L');
$pdf->Cell(6,1,'Diskon : '.$dataku['disc']. '   %',0,1, 'L');
...
$pdf->Cell(6,1,': Rp '.$dataku['hasil2'],0,1, 'L');
$pdf->Cell(6,1,'Tanggal Booking',0,0,'L');
$pdf->Cell(6,1,': '.$dataku['tgl_booking'],0,1, 'L');
$pdf->Ln(1);
for($i=1;$i<=1;$i++)
{
$pdf->MultiCell(0, 1, 'Silahkan anda melakukan pembayaran melalui ATM kepada kami : BNI (009) 12300001222 An. EComtob atau BRI (008) 9000000021 An. EComtob sejumlah   Rp '.$dataku['hasil2']. ' kemudian lakukan konfirmasi pembayaran pada halaman Dashboard anda');
$pdf->MultiCell(0,1,'');
}
$pdf->Ln(1);
$pdf->Ln(1);
