    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
				<form role="form" method="post" action="config/bayar.php">
				<div class="col-lg-6">
					<?php
				...
				<div class="col-lg-6">
					...
					<div class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy-mm-dd" data-link-field="" data-link-format="yyyy-mm-dd">
						<input class="form-control" size="10" type="text" name="tgl_bayar">
						<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
					</div>
					</div>
					<?php
						if ($dataku->pembayaran>0)
						{
						echo"<h3>Sudah Dibayar</h3>";
						}
						else
						{
						echo"
						<div class='row form-actions'>
							<div class='col-sm-12'>
								<button type='submit' class='btn btn-primary pull-right'><i class='icon-user-plus'></i> Bayar</button>
							</div>
						</div>
						";
